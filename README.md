...
```bash
release-assets/v0.7.0/cli-weather_0.7.0_all.deb
```

Install directly from the checked-out repository:

```bash
sudo dpkg -i release-assets/v0.7.0/cli-weather_0.7.0_all.deb
```
...
```bash
sudo dpkg -i dist/cli-weather_0.7.0_all.deb
```
...
```bash
release-assets/v0.7.0/cli-weather-0.7.0-1.noarch.rpm
```

Install directly from the checked-out repository:

```bash
sudo rpm -i release-assets/v0.7.0/cli-weather-0.7.0-1.noarch.rpm
```
...
```bash
sudo rpm -i dist/rpmbuild/RPMS/noarch/cli-weather-0.7.0-1.noarch.rpm
```
