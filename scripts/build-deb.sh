...
PACKAGE_ROOT="${BUILD_DIR}/cli-weather_0.5.0_all"
...
mkdir -p "${DIST_DIR}"
dpkg-deb --build "${PACKAGE_ROOT}" "${DIST_DIR}/cli-weather_0.5.0_all.deb"
echo "Built ${DIST_DIR}/cli-weather_0.5.0_all.deb"
